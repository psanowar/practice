        ...
        <div class="tx-center mg-b-40">The Admin Template For Perfectionist</div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <x-input id="name" class="form-control block mt-1 w-full" placeholder="Enter Your Name" type="text" name="name" :value="old('name')" required autofocus />
                </div>
                ...
                <div class="mt-4 form-group">
                    ...
                    <x-input id="email" class="form-control block mt-1 w-full" placeholder="Enter Your Email" type="email" name="email" :value="old('email')" required />
                </div>
                ...
                <div class="mt-4 form-group">
                    ...
                    <x-input id="password_confirmation" placeholder="Enter Confirm Password" class="form-control block mt-1 w-full"
                                    type="password"
